                ...
                <LazyMotion features={domAnimation}>
                    ...
                    >
                        <div className="mr-auto place-self-center ">
                            <h1 className="mb-4 max-w-2xl text-center text-4xl font-extrabold leading-none tracking-tight dark:text-white md:text-left md:text-5xl xl:text-6xl">
                                I bring ideas to life, from DESIGN to DATABASE!
                            </h1>
