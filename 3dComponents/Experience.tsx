...
const Experience = () => {
    ...
    return (
        <>
            ...
            {page === 'skills' && <RigidBody type='fixed' position={[-12, -5, 33]} rotation={[0, Math.PI * 0.85, 0]}><Map /></RigidBody>}
            {page === 'projects' && <RigidBody type='fixed' position={[0, -5, 0]}><Plane /></RigidBody>}
