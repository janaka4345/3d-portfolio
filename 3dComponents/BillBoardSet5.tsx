...
export function BillBoardSet5(props: JSX.IntrinsicElements['group']) {
    ...
    const { nodes, materials } = useGLTF('/billboardSet5.glb') as GLTFResult
    ...
    return (
        <group {...props} dispose={null}>
            <group name="Scene">
                ...
                <RigidBody type="fixed" colliders='hull' ><group
                    name="billboard"
                    position={[2.732, 2.206, -1.47]}
                    rotation={[0, 1.571, 0]}
...
useGLTF.preload('/billboardSet5.glb')
